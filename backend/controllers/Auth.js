...
exports.resendOtp=async(req,res)=>{
    try {
        ...
        await sendMail(existingUser.email,`OTP Verification for Your Account`,`Your One-Time Password (OTP) for account verification is: <b>${otp}</b>.</br>Do not share this OTP with anyone for security reasons`)
...
exports.forgotPassword=async(req,res)=>{
    ...
    try {
        ...
        await sendMail(isExistingUser.email,'Password Reset Link for Your Account',`<p>Dear ${isExistingUser.name},
